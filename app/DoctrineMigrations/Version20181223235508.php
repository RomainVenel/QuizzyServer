 ...
 */
class Version20181223235508 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE part CHANGE description description VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
